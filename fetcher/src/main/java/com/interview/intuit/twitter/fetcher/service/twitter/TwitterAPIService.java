...
public class TwitterAPIService {
    private static final Logger logger = LogManager.getLogger(TwitterAPIService.class);
    ...
    public TwitterAPIService(RedisService redisService) {
    ...
    public List<TweetDTO> fetchTweetsFromTwitterApi() {
        ...
        try {
            ...
            sinceId = (result.getMeta().getNewestId() != null) ? result.getMeta().getNewestId() : sinceId;
            redisService.setKey(String.format("latestTweetIdFetched_%s", keyword), sinceId);
